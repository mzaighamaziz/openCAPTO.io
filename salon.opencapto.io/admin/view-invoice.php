...
<td><input type="text" id="discount" name="discount">
	<input type="submit" value="Discount" name="discountt">
 </td>
</form>
<th>Grand Total </th>
<th id="totalgrand"><?php echo $grantTotal?></th>
</tr>
</table>
...
$('#discount').keyup(function(){
	var value=$(this).val();
	var total='<?php echo $gtotal ?>';

	var grandTotal=value-total;
