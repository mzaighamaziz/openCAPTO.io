...
?>
						 ...
						 <td><a href="edit-customer-detailed.php?editid=<?php echo $row['ID'];?>">Edit</a>  ||  <a href="add-customer-services.php?addid=<?php echo $row['ID'];?>">Assign Services</a> || <a href="delete-customer.php?id=<?php echo $row['ID'];?>">Delete</a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
				</div>
