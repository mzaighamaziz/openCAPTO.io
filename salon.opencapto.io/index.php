...
if (isset($_POST['submit'])) {
	...
	$query = mysqli_query($con, "insert into tblappointment values (null,'$aptnumber','$name','$email','$phone','$adate','$atime','$services','$dateS',0,0,0)");
	if ($query) {
		$ret = mysqli_query($con, "select * from tblappointment where Email='$email' and  PhoneNumber='$phone'");
		$result = mysqli_fetch_array($ret);
		$number='+'.$result['PhoneNumber'];
		echo $number;
		// Account details

	$apiKey = urlencode('dFSuz9ESGsw-2sES9C2OhRQkF318SZcjqjLC3bGUAM');
						...
						<div class="appointment-wrap">
							...
							<form action="" method="POST" class="appointment-form">
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" required="true" maxlength="15">
										</div>
									</div>
								</div>
								<div class="form-group">
